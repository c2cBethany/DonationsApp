...
import com.example.donationsapp.NewReceiversPost
...
class ReceiversFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.fabReceiversPost.setOnClickListener {
            val intent = Intent(activity, NewReceiversPost::class.java)
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Receivers Posts")
